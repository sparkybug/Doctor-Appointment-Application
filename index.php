...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="icPatient" placeholder="Matriculation Number" required>
                                                </div>
                                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="number" name="icPatient" value="" class="form-control input-lg" placeholder="Your Matriculation Number"  required/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>These are Doctor's Schedule. Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <!-- <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Got any health related question?</h1>
                    <hr>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© IMT FUTO</p>
